...
typedef uint64_t (__ms_abi *cdk2_memory_test_init_fn)(
	struct cdk2_generic_memory_test *memory_test, uint32_t level,
	uint8_t *require_soft_ecc_init);
typedef uint64_t (__ms_abi *cdk2_perform_memory_test_fn)(
...
typedef uint64_t (__ms_abi *cdk2_memory_test_finished_fn)(
	struct cdk2_generic_memory_test *memory_test);
typedef uint64_t (__ms_abi *cdk2_compatible_range_test_fn)(
