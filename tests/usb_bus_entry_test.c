...
struct fixture { struct loaded_image loaded; struct cdk2_usb2_hc_protocol host;
	...
	UINTN events, event_closes; event_notify_fn * notify;
...
{ (void)type; (void)tpl; (void)context; fixture.notify = notify;
	*event = &fixture.events; fixture.events++; return EFI_SUCCESS; }
...
{
	fixture.installs++;
	if (protocol == &binding_guid && interface == &binding)
