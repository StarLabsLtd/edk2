...
{
	static const uint8_t guid[16] = { 0xa7, 0xb4, 0xb4, 0x9f, 0xc0, 0x42,
		0xcd, 0x4b, 0x85, 0x40, 0x9b, 0xcc, 0x67, 0x11, 0xf8, 0x3e };
	static const uint8_t types[] = { 0x10, 0x15, 0x14 };
	static const uint8_t ui[] = { 'U', 0, 's', 0, 'b', 0, 'M', 0, 'a', 0,
		's', 0, 's', 0, 'S', 0, 't', 0, 'o', 0, 'r', 0, 'a', 0, 'g', 0,
		'e', 0, 'D', 0, 'x', 0, 'e', 0, 0, 0 };
