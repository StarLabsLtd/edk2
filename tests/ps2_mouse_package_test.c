...
{
	static const uint8_t guid[16] = { 0x31, 0x45, 0x46, 0x08, 0x99, 0x4c,
		0x4c, 0x4c, 0xa8, 0x87, 0x8d, 0x8b, 0xa4, 0xbb, 0xb0, 0x63 };
	static const uint8_t types[] = { 0x10, 0x15, 0x14 };
	static const uint8_t ui[] = { 'P', 0, 's', 0, '2', 0, 'M', 0, 'o', 0,
