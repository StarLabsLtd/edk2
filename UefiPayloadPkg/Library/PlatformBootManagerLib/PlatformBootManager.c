...
#define BOOT_PROMPT_HIDPI_HORIZONTAL_RESOLUTION  1920
#define BOOT_PROMPT_HIDPI_VERTICAL_RESOLUTION    1080
  ...
  )
{
  ...
  return (HorizontalResolution > BOOT_PROMPT_HIDPI_HORIZONTAL_RESOLUTION) &&
         (VerticalResolution > BOOT_PROMPT_HIDPI_VERTICAL_RESOLUTION) &&
