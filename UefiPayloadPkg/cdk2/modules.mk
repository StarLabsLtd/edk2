...
CDK2_EFFECTIVE_LINUX_EFI_APPLICATION := $(call CDK2_EFFECTIVE_BOOL,LINUX_EFI_APPLICATION_BOOT,$(CONFIG_CDK2_LINUX_EFI_APPLICATION))
...
CDK2_EFFECTIVE_SECURE_BOOT_ASSUME_SETUP_PHYSICAL_PRESENCE := $(call CDK2_EFFECTIVE_BOOL,CDK2_SECURE_BOOT_USER_PHYSICAL_PRESENCE,$(CONFIG_CDK2_SECURE_BOOT_ASSUME_SETUP_PHYSICAL_PRESENCE))
CDK2_EFFECTIVE_EVIL_MAID_PROTECTION := $(call CDK2_EFFECTIVE_BOOL,CDK2_ANTI_TAMPER_BOOT,$(CONFIG_CDK2_EVIL_MAID_PROTECTION))
CDK2_EFFECTIVE_EVIL_MAID_REQUIRE_TPM_PPI := $(call CDK2_EFFECTIVE_BOOL,CDK2_ANTI_TAMPER_REQUIRE_TPM_PPI,$(CONFIG_CDK2_EVIL_MAID_REQUIRE_TPM_PPI))
CDK2_EFFECTIVE_EVIL_MAID_SHUTDOWN_ON_FAILURE := $(call CDK2_EFFECTIVE_BOOL,CDK2_ANTI_TAMPER_SHUTDOWN_ON_FAILURE,$(CONFIG_CDK2_EVIL_MAID_SHUTDOWN_ON_FAILURE))
