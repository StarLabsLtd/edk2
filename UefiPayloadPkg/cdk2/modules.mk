...
CDK2_EFFECTIVE_LVGL := $(call CDK2_EFFECTIVE_BOOL,LVGL_ENABLE,$(CONFIG_CDK2_LVGL))
...
CDK2_FEATURE_MODULES := \
    ...
    $(CDK2_GRAPHICS_MODULES) \
    $(CDK2_SETUP_UI_MODULES) \
    $(if $(filter y,$(CDK2_EFFECTIVE_LVGL)),$(CDK2_LVGL_MODULES)) \
    $(CDK2_USB_MODULES) \
    $(CDK2_ATA_MODULES) \
    $(CDK2_SD_MODULES) \
    $(CDK2_NVME_MODULES) \
...
$(eval $(call CDK2_SELECT_FEATURE_MODULES,LVGL,CDK2_LVGL_MODULES))
