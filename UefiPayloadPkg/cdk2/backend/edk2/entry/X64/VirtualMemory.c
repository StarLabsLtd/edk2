/** @file
  ...
  Coreboot establishes the processor cache attributes before entering the
  payload. This code creates the identity page tables without reprogramming
  MTRRs; page-table attributes are derived from the payload memory policy.
