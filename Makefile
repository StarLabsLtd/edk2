...
CDK2_CONFIG_TARGETS := build check manifest modules native-stage \
	...
	native-status-code-handler-test native-disk-io-test native-disk-io-fv \
	...
	native-smm-access-test native-smm-access-fv \
	native-smm-control-test native-smm-control-fv \
	native-cpu-io2-smm-test native-cpu-io2-smm-fv \
	...
	native-con-splitter-test native-con-splitter-fv native-con-splitter-fv-exact \
...
CDK2_RECURSIVE_ARGS := \
	...
	$(if $(CDK2_NATIVE_PRE_CON_SPLITTER_FV),CDK2_NATIVE_PRE_CON_SPLITTER_FV="$(CDK2_NATIVE_PRE_CON_SPLITTER_FV)") \
...
.PHONY: all build build-image config defconfig olddefconfig menuconfig \
	...
	native-disk-io-test native-disk-io-fv \
	native-serial-io-test native-serial-io-fv \
	native-smbios-test native-smbios-fv \
	native-reset-system-test native-reset-system-fv \
	native-pcat-rtc-test native-pcat-rtc-fv \
